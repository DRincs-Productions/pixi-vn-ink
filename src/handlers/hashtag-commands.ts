...
import { convertTagTolist as _convertTagTolist, mergeJsonBlocks as _mergeJsonBlocks } from "@/utils/hashtag-utility";
...
export namespace HashtagCommands {
    ...
    export const convertTagTolist = _convertTagTolist;
    export const mergeJsonBlocks = _mergeJsonBlocks;
